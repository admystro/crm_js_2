...
export const formAddManager = document.querySelector('.add-manager-form');
export const resultTable = document.querySelector('#result_table');

export const multiSelect = document.getElementById('select');
export const multiSelectControl = document.querySelector('.select-control');
export const multiSelectOptions = document.querySelector('.select-options');
